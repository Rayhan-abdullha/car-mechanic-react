const Gallery = () => {
  return (
    <div className="singlePhoto-gallery">
      ...
      >
        <div className="image-card big mb-5 sm:mb-0">
          <img
        ...
        <div className="image-card small mb-5 sm:mb-0">
          <img
        ...
        <div className="image-card small mb-5">
          <img
            src="https://vid.alarabiya.net/images/2023/04/12/2d220739-e6e3-4f4a-86f0-672691659959/2d220739-e6e3-4f4a-86f0-672691659959.jpg?crop=1:1&width=1000"
            alt="notfound"
          />
      ...
      <div className="text-center mt-5">
        <button className="text-bg-slate-400 text-[18px] font-semibold uppercase w-[200px] h-[60px] bg-[#D9D9D9] hover:bg-slate-300">
          See All
        </button>
      </div>
    </div>
