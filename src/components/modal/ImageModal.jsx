...
const ImageModal = ({ isOpen, closeModal, imageInfo, images }) => {
  ...
  return (
    <div className="modal-gallery fixed overflow-scroll top-0 left-0 w-full h-full flex justify-center items-center bg-black bg-opacity-[.2] backdrop-blur-[1px] z-50">
      <div className="modal-wrapper bg-white p-8 rounded-lg max-w-[1000px]">
        <IoMdClose
